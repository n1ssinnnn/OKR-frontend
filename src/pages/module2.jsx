          ...
          <Box sx={{ maxWidth: 1200, mx: 'auto', py: 2 }}>
            {assignorGroups.map((group, gIndex) => (
              <Box key={gIndex} sx={{ position: 'relative', display: 'flex', alignItems: 'center', mb: 6 }}>
                ...
                {/* SVG CONNECTOR LINES */}
                <Box sx={{ width: 80, flexShrink: 0, position: 'relative', alignSelf: 'stretch', }}>
                  <svg width="100%" height="100%" viewBox = "0 0 90 100" preserveAspectRatio="none" style={{ position: 'absolute', top: 0, left: 0, overflow: 'visible' }}>
                    ...
                    {group.okrs.length > 1 && (
                      <>
                        ...
                        <path d="M 0 50 L 35 50" fill="none" stroke={mode === 'dark' ? '#475569' : '#94A3B8'} strokeWidth="1"/>
                    ...
                    {group.okrs.map((_, i) => {
                      ...
                      return (
                        <path
                          key={i}
                          d={`M ${total === 1 ? 0 : 35},${endY} L 90,${endY}`}
                          fill="none"
                          stroke={mode === 'dark' ? '#475569' : '#94A3B8'}
                          strokeWidth={group.okrs.length === 1 ? 2.5 : 1}
